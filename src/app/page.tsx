    ...
    <main className="relative min-h-screen overflow-x-hidden flex flex-col bg-aura-cream font-sans">
      ...
      <section className="relative w-full min-h-[90vh] flex flex-col justify-center items-center pt-32 pb-40 px-8 z-20 bg-aura-cream overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute top-[10%] right-[15%] w-[400px] h-[400px] bg-aura-pink/20 rounded-full blur-[100px] pointer-events-none mix-blend-multiply"
        />
        <motion.div
          animate={{ x: [0, -40, 30, 0], y: [0, 40, -40, 0], scale: [1, 0.85, 1.1, 1] }}
          transition={{ duration: 22, repeat: Infinity, ease: "easeInOut" }}
          className="absolute bottom-[20%] left-[10%] w-[500px] h-[500px] bg-aura-blue/20 rounded-full blur-[120px] pointer-events-none mix-blend-multiply"
        />
        ...
        >
          <motion.div 
            ...
            className="mb-8"
          >
            <Sparkles className="w-8 h-8 text-aura-pink/60 animate-pulse" />
          </motion.div>
          ...
          <h1 className="font-serif text-6xl md:text-8xl lg:text-[7rem] leading-[1.05] text-aura-dark font-medium tracking-tight text-balance">
            The art of <br/>
            <span className="italic text-aura-pink font-light pr-2">noticing</span>
            everything.
          </h1>
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-16">
          <div className="flex-1 space-y-6">
            ...
            <h2 className="font-serif text-4xl md:text-5xl text-aura-dark leading-tight">
              Capturing the <span className="italic text-aura-pink">ephemeral</span> moments of daily life.
            </h2>
          ...
          <div className="flex-1 relative">
             <div className="relative w-full aspect-square md:aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl transform rotate-2 hover:rotate-0 transition-transform duration-700 border-4 border-[#faf8f5]/50">
               <div className="absolute inset-0 bg-gradient-to-br from-aura-blue/20 to-aura-pink/20 mix-blend-multiply z-10" />
             ...
             {/* Decorative star */}
             <Star className="absolute -top-6 -right-6 w-12 h-12 text-aura-pink fill-aura-pink animate-[spin_10s_linear_infinite]" />
          </div>
        </div>
      </section>
      ...
      <div className="relative w-full bg-[#e6ddcf] z-20 transform -translate-y-[1px]">
         <svg className="block w-full h-[60px] md:h-[100px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" preserveAspectRatio="none">
            ...
            <Link key={item.id} href={`/blog/${item.id}`} className="block">
              ...
              >
                <div className="relative w-full aspect-square bg-gray-200 overflow-hidden rounded-sm">
                  <div className="absolute inset-0 bg-aura-pink/10 mix-blend-overlay z-10" />
      ...
      <div className="relative w-full bg-aura-dark z-20 transform -translate-y-[1px]">
         <svg className="block w-full h-[80px] md:h-[150px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" preserveAspectRatio="none">
      ...
      <section className="relative w-full py-32 px-8 bg-aura-dark text-aura-cream z-20 flex flex-col items-center min-h-[60vh] justify-center">
        ...
        <div className="max-w-4xl w-full text-center flex flex-col items-center space-y-10 z-10">
          <h2 className="font-serif text-5xl md:text-7xl leading-tight">
            Dive into the <span className="italic text-aura-mutedPink">complete</span> collection.
          </h2>
          ...
          <Link href="/blog">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="group relative px-10 py-5 border border-aura-cream/30 text-aura-cream rounded-full overflow-hidden transition-all duration-300 flex items-center gap-3 font-sans text-sm tracking-widest uppercase mt-8 hover:shadow-[0_0_30px_rgba(255,107,179,0.15)]"
            >
              Explore the archive 
